...
public:
  ...
  // Notice: _x and _y is the coordinate the lower left corner of the font
  static void drawASCII(float _x, float _y, const std::string &_text) { get()->_drawASCII(_x, _y, _text); }
  virtual void _drawASCII(float _x, float _y, const std::string &_text) {}
  static void drawUTF8(float _x, float _y, const std::string &_text) { get()->_drawUTF8(_x, _y, _text); }
  virtual void _drawUTF8(float _x, float _y, const std::string &_text) {}
  ...
  static void drawBMP(float _x, float _y, float _w, float _h, const unsigned char *_bitMap) { get()->_drawBMP(_x, _y, _w, _h, _bitMap); }
  ...
  static void drawRBox(float _x, float _y, float _w, float _h, float _r) { get()->_drawRBox(_x, _y, _w, _h, _r); }
  ...
  static void drawRFrame(float _x, float _y, float _w, float _h, float _r) { get()->_drawRFrame(_x, _y, _w, _h, _r); }
