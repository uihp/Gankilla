...
std::vector<uint8_t> word_icon = {
  0xF0, 0xFF, 0xFF, 0xC3, 0xFC, 0xFF, 0xFF, 0xCF, 0xFE, 0xFF, 0xFF, 0xDF, 0xFE, 0xFF, 0xFF, 0xDF,
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC,
  0xFF, 0xFF, 0xFF, 0xF8, 0xFF, 0xF3, 0xFB, 0xF8, 0xFF, 0xF8, 0xFB, 0xF8, 0x3F, 0xF8, 0xF9, 0xFC,
  0x4F, 0x7C, 0xFC, 0xFE, 0x67, 0x3C, 0xFC, 0xFE, 0x67, 0xBC, 0x7C, 0xFF, 0x27, 0x9C, 0x7C, 0xFF,
  0x27, 0xCE, 0x1C, 0xFF, 0x3F, 0xEE, 0x8C, 0xFF, 0x3F, 0xF4, 0xC4, 0xFF, 0x3F, 0x70, 0xE0, 0xFF,
  0x3F, 0x78, 0xF0, 0xFF, 0x7F, 0x7C, 0xF0, 0xFF, 0x7F, 0x7E, 0xFC, 0xFF, 0x7F, 0x7E, 0xFC, 0xFF,
  0xFF, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xDF, 0xFE, 0xFF, 0xFF, 0xDF,
  0xFC, 0xFF, 0xFF, 0xCF, 0xF0, 0xFF, 0xFF, 0xC3
};
...
void astraCoreInit(void) {
  ...
  rootPage->addItem(new astra::List("Word", word_icon));
      ...
      if (HAL::getKeyMap()[i] == key::CLICK) {
        if (i == 0) { astraLauncher->getSelector()->goPreview(); }//selector去到上一个项目
          ...
          if (astraLauncher->open()) {
            ...
            else if (astraLauncher->currentMenu->getNextMenu()->title == "Word")
              main4Word();
          }
        }//打开当前项目
